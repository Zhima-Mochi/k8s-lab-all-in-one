...
# Build script for the thumb service
# Usage: ./build.sh [tier]
...
echo "Building thumb service with tag: $TAG"
echo "===================================="

# Build the Docker image
docker build -t thumb:$TAG .

echo "thumb service built successfully with tag thumb:$TAG"
