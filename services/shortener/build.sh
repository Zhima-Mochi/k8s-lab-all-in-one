...
# Build script for the shortener service
# Usage: ./build.sh [tier]
...
echo "Building shortener service with tag: $TAG"
echo "========================================"

# Build the Docker image
docker build -t shortener:$TAG .

echo "shortener service built successfully with tag shortener:$TAG"
